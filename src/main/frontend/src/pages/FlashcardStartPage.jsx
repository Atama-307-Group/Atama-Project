    ...
    <div className="start-page">
      ...
      <div className="start-content">
        ...
        <div className="action-buttons">
          <button className="action-btn" onClick={onStart}>Study</button>
          <button className="action-btn" onClick={() => alert('Match soon...')}>Match</button>
          <button className="action-btn" onClick={() => alert('Practice Test soon...')}>Practice Test</button>
          <button className="action-btn" onClick={() => alert('Other cool feature soon...')}>Other cool feature</button>
        </div>
      </div>
    </div>
  );
